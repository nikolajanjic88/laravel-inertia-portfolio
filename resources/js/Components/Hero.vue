<template>
    <section id="home" class="flex lg:h-[85vh] items-center bg-zinc-950 py-32 lg:py-0 overflow-hidden">
        <div class="container mx-auto h-full">
            <div class="items-center h-full flex pt-8 text-teal-300">
                ...
                <div class="hidden lg:flex flex-1 justify-end items-center h-full">
                    <img src="http://127.0.0.1:8000/img/wolf.jpg" class="w-2/3 rounded-lg" alt="">
                </div>
            </div>
        </div>
    </section>
